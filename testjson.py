...
# ---------------------------------------------------------------------------------
# liquidity = "https://api.covalenthq.com/v1/1/uniswap_v3/liquidity/address/0x030bA81f1c18d280636F32af80b9AAd02Cf0854e/?key=ckey_373f6fe9f142487689b67de0e72"

# liquidity = 'https://api.covalenthq.com/v1/1/address/0xe137363a81be8Ac17b31237442aAD992996c4657/stacks/uniswap_v2/acts/?quote-currency=USD&format=JSON&swaps=true&key=ckey_docs'
# # liquidity = 'https://api.covalenthq.com/v1/56/address/0x4204777da532bBBd9F551637d3A807e7Dc3344C0/stacks/pancakeswap/acts/?quote-currency=USD&format=JSON&swaps=true&key=ckey_docs'

# liquidity_data = requests.get(liquidity)
# print(colored(liquidity_data.json(),'cyan'))
...
##--------------Algod-Balance------------------------##
            ...
            # print (colored(algod_balance,'cyan'))

##---------------------liquidity Data Url--------------------------##
# ckey_16f42f9880a54dc5be9b8237f50

# https://api.covalenthq.com/v1/1/uniswap_v3/liquidity/address/0xadac84746417fbfba17480E6Cbc1360bCa54330E/?key=ckey_16f42f9880a54dc5be9b8237f50
            # liquidity = f'https://api.covalenthq.com/v1/1/uniswap_v3/liquidity/address/0x5d44a02c9e2ed366fb987793d90216b0609aa55c/?key=ckey_373f6fe9f142487689b67de0e72'
            liquidity = f'https://api.covalenthq.com/v1/1/uniswap_v3/liquidity/address/0xadac84746417fbfba17480E6Cbc1360bCa54330E/?key=ckey_373f6fe9f142487689b67de0e72'
            liquidity_data = requests.get(liquidity)
            Eth_liquidity = liquidity_data.json()
            # print(colored(Eth_liquidity,'cyan'))
# -----------------------------------------------------#
            ...
            if request.form and request.form["form-submit"]:
                ...
                return render_template("index.html",data = response_data,jsonfile = SolanaToken,len = len(SolanaToken))
                ...
                ether_responce = {"balance" : float(ether),"Token" : ETHER_token,"Liquidity_Transactions" : Eth_liquidity}
                ...
                main_obj = {"Ethereum" : ether_responce,"Binance" : bsc_responce,
                    "Polygon" : polygon_responce,"Fantom" :fantom_responce,"Hecoinfo":hecoinfo_responce,"Solana" : solana_responce}
                return main_obj
